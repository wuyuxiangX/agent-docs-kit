...
- Renamed the PyPI distribution to `yudocs` because `living-docs` is blocked by PyPI's project-name similarity checks. The `living-docs` CLI command remains available.
